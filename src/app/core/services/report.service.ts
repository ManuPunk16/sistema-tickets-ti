...
export class ReportService {
  ...
  getTicketMetrics(startDate?: Date, endDate?: Date): Observable<TicketMetric> {
    let q = query(this.ticketsCollection);
          ...
          tickets.forEach(ticket => {
            ...
            if (ticket['status'] === 'resuelto' || ticket['status'] === 'cerrado') {
              ...
              if (ticket['resolvedAt'] && ticket['createdAt']) {
                ...
                // Determinar si se resolvió dentro del SLA (esto requeriría información adicional sobre SLAs)
                // Por ahora usamos valores estáticos de ejemplo
                let targetTime;
      ...
      .pipe(
        map(tickets => {
          ...
          tickets.forEach(ticket => {
            ...
            // Procesar usuario asignado (resolutor)
